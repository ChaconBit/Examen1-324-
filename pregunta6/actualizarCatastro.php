    ...
    <div class="container mt-5">
        ...
        <form action="actualizarCatastro.php" method="POST">
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="id" value="<?php echo htmlspecialchars($id); ?>"
                    readonly>
            </div>
            <div class="mb-3">
                <label for="zona" class="form-label">Zona</label>
                <input type="text" class="form-control" id="zona" name="zona"
                    value="<?php echo htmlspecialchars($zona); ?>" required>
            </div>
            <div class="mb-3">
                <label for="Xini" class="form-label">X Inicial</label>
                <input type="number" class="form-control" id="Xini" name="Xini"
                    value="<?php echo htmlspecialchars($Xini); ?>" step="0.01" required>
            </div>
            <div class="mb-3">
                <label for="Yini" class="form-label">Y Inicial</label>
                <input type="number" class="form-control" id="Yini" name="Yini"
                    value="<?php echo htmlspecialchars($Yini); ?>" step="0.01" required>
            </div>
            <div class="mb-3">
                <label for="Xfin" class="form-label">X Final</label>
                <input type="number" class="form-control" id="Xfin" name="Xfin"
                    value="<?php echo htmlspecialchars($Xfin); ?>" step="0.01" required>
            </div>
            <div class="mb-3">
                <label for="Yfin" class="form-label">Y Final</label>
                <input type="number" class="form-control" id="Yfin" name="Yfin"
                    value="<?php echo htmlspecialchars($Yfin); ?>" step="0.01" required>
            </div>
            <div class="mb-3">
                <label for="superficie" class="form-label">Superficie</label>
                <input type="text" class="form-control" id="superficie" name="superficie"
                    value="<?php echo htmlspecialchars($superficie); ?>" required>
            </div>
            <div class="mb-3">
                <label for="distrito" class="form-label">Distrito</label>
                <input type="text" class="form-control" id="distrito" name="distrito"
                    value="<?php echo htmlspecialchars($distrito); ?>" required>
            </div>
            <div class="mb-3">
                <label for="ci" class="form-label">CI</label>
                <input type="number" class="form-control" id="ci" name="ci" value="<?php echo htmlspecialchars($ci); ?>"
                    readonly>
            </div>
